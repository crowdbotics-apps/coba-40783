"""
Django settings for coba_40783 project.
...
WSGI_APPLICATION = 'coba_40783.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "coba_40783 API",
    "DESCRIPTION": "API documentation for coba_40783 App",
    "VERSION": "v1",
}
